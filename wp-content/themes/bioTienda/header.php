...
<body class="relative">
    <?php wp_body_open() ?>
    <div class="sticky -top-0 z-[60] inline-flex w-full m-ext bg-green">
    ...
    <!-- ------------------------------------ Desktop ---------------->
    <div class="w-full hidden pt-10 fixed z-[52] lg:inline-flex m-ext top-0 bg-white border-b-[1px]">

...
<main class="">
    <!-- =========================================================== Iconos -->
    <section id="iconos" class="inline-flex flex-row justify-between w-full my-24 m-ext">
        <div class="p-3">
    ...
    <!-- =========================================================== Minibanners -->
    <section id="minibanners" class="grid grid-cols-4 grid-rows-2 gap-5 m-ext">
    ...
    <!-- =========================================================== Asesorias/Talleres -->
    <section id="asesorias" class="relative grid grid-cols-3 gap-5 py-10 m-ext bg-green auto-rows-max my-11">
        ...
        <div class="col-span-full">
            <img class="mx-auto my-16 max-h-10" src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/icons/logo-white.svg" alt="Logo bioTienda">
            <p class="mx-[15%] text-lg text-center font-normal text-white">Entendemos la salud y el bienestar como un conjunto, y nuestro deber es propiciar un equilibrio entre el cuerpo y la mente.
            </p>
        ...
        <div class="z-10 flex flex-col col-span-1 p-10 text-center text-white bg-green-dark">
            ...
            <a class="inline-block px-10 py-2 m-auto bg-green" href="">LEER MAS</a>
        </div>

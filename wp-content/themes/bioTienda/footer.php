<footer class="flex flex-row justify-around py-16 text-white m-ext bg-green-dark">
    <ul>
        <li>
    ...
    <ul class="ml-5">
        ...
        <li class="mt-3 hover:text-green hover:font-semibold"><a href="">Nosotros</a></li>
        <li class="mt-3 hover:text-green hover:font-semibold"><a href="">Blog</a></li>
        <li class="mt-3 hover:text-green hover:font-semibold"><a href="">bioTienda</a></li>
        <li class="mt-3 hover:text-green hover:font-semibold"><a href="">Salud funcional</a></li>
        <li class="mt-3 hover:text-green hover:font-semibold"><a href="">Contacto</a></li>
    </ul>
    <ul class="ml-5">
        <li>
        ...
        <li class="font-semibold">
            ...
            <a class="block mt-3 hover:text-green" href="">
    ...
    <ul>
        ...
        <li>
            <form action="" class="flex flex-col mt-3">
                ...
                <input class="w-full py-2 bg-transparent border-2 rounded-xl" type="text" name="numeroGuia" id="numeroGuia">
                <button class="px-8 py-4 mx-auto mt-3 text-lg font-semibold text-green-dark bg-green">Rastrea tu pedido</button>
            </form>
        </li>
        <li class="mt-10">

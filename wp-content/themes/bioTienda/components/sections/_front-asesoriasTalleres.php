<section id="asesorias" class="relative grid grid-cols-1 gap-5 py-10 lg:grid-cols-3 m-ext bg-green auto-rows-max my-11">
    ...
    <div class="col-span-full">
        ...
        <img class="mx-auto mt-10 lg:mt-16 max-h-72" src="<?= LOGOURL_WHITE ?>" alt="Logo bioTienda">
        <p class="mx-[15%] text-lg mb-10 text-center font-normal text-white">Entendemos la salud y el bienestar como un conjunto, y nuestro deber es propiciar un equilibrio entre el cuerpo y la mente.
        </p>

<!-- =========================================================== Iconos -->
<div class="bg-[#F6F9EA] w-full m-ext mt-12">
    <section id="iconos" class="grid flex-row flex-wrap w-full grid-cols-2 py-16 mx-auto max-w-bt lg:flex lg:justify-between">
        <div class="p-3">
